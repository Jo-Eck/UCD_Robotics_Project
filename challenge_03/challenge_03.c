...
//place gyro at s3 and color at clamp connected to s4 maybe?
...
void doSweepSearch(){
    rotateBase(180); //sweep right
    rotateBase(0); //return to base
    rotateBase(-180); //sweep left
    rotateBase(0); //return to base
}
...
task main()
{
    ...
    while (!objectSeen){ //keep repeatedly sweeping until object found
        doSweepSearch();
